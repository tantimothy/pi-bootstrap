...
PIHOLE_PASSWORD="${PIHOLE_PASSWORD:-CHANGE_ME_TO_A_SECURE_PASSWORD}"
MONITORING_ENABLE="${MONITORING_ENABLE:-true}"
MONITORING_GRAFANA_ADMIN_PASSWORD="${MONITORING_GRAFANA_ADMIN_PASSWORD:-CHANGE_ME_TO_A_SECURE_PASSWORD}"
